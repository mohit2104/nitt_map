...
fwrite($file,"14,17,14,15,5,15,16,17,18,19,21,12,13,18,13,14,13,9,20,9,11,12,11,10,8,7,14,7,6,5,20,5,4,0,1,6,1,2,7,2,3,8,3");
fclose($file);
 //echo $file1;
?>
...
var x=["garnet","mess B","Ceesat f","chem eng","Diamond","Aavin","Agate","ceesat r","Admin H","EEE","NITT GATE","INT","SAC","Civil","Vasntan","Coral","SC","CSE","IIM","OPAL","OCTA","LIBRARY"];
//var x=["goe","dhdid"];
var a=[[0,700],[200,680],[500,720],[700,700],[0,400],[200,400],[200,500],[500,550],[700,530],[700,400],[900,500],[900,400],[900,300],[700,300],[500,300],[200,300],[200,0],[500,0],[700,10],[950,0],[500,400],[900,100]];
...
context.fillText(x[b[i]]+"("+b[i]+")", a[b[i]][0]*c+15,a[b[i]][1]*c1+22);
 ...
 context.beginPath();
	...
	context.strokeStyle = 'rgba('+r+','+r1+','+r2+',0.7)';
	  ...
	  <span style="position:absolute;bottom:3%;right:4%;font-size:14px;">&copy Mohit's_project</span>
	  </body>